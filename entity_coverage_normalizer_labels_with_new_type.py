...
# data_df = pandas.read_csv('data/combined_3_v2/train_combined_3_38K.csv', sep='\t')
data_df = pandas.read_csv('data/combined_3_v2/dev_combined_3_4K.csv', sep='\t')
...
# df.to_csv('data/combined_3_v2/train_combined_3_38K_normalized.csv', sep='\t', index=False)
df.to_csv('data/combined_3_v2/dev_combined_3_4K_normalized.csv', sep='\t', index=False)
